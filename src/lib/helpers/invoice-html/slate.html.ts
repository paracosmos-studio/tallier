...
const CSS = `:root { --charcoal: #1a1c1e; --amber: #e8a13c; --ghost: #c9ccd1; --rowfill: #f1f2f3; --ink: #1f2124; --muted: #6b7280; --sans: "Instrument Sans", ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, sans-serif; }
...
.panel { margin: 0 -1.75rem 0; padding: 2.25rem 1.75rem 3rem; background: var(--charcoal); color: #fff; }
...
.summary { display: grid; grid-template-columns: repeat(4, 1fr); gap: 0.6rem; margin: -32px 0 2rem; }
 ...
 * borderless table with uniform amber-accented header bands.
 *
