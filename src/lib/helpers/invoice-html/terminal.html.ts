...
.invoice { color: var(--ink); font-family: var(--mono); font-size: 0.85rem; line-height: 1.5; }
...
.parties { display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.1rem; }
.parties h2 { margin: 0 0 0.3rem; font-size: 0.85rem; font-weight: 500; }
.summary { margin: 0 0 0.4rem; }
