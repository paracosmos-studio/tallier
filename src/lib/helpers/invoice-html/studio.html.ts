...
.invoice { color: var(--ink); font-family: var(--sans); font-size: 0.95rem; line-height: 1.55; max-width: 52rem; padding: 3rem 2.5rem; margin: 0 auto; }
...
.docno { margin: 0.5rem 0 0; color: var(--accent); font-weight: 500; }
.layout { display: grid; grid-template-columns: 30% 1fr; gap: 2.5rem; margin-top: 3.5rem; }
